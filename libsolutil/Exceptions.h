...
#define SOL_NOINLINE __attribute__((noinline)) __attribute__((used))
#else
#define SOL_NOINLINE
#endif
...
)
{
	::boost::throw_exception(
		ExceptionType() <<
		::solidity::util::errinfo_comment(std::string(std::forward<Description>(_description))) <<
...
#define solThrow(_exceptionType, _description) \
	::solidity::util::solThrowImpl<_exceptionType>((_description), ETH_FUNC, __FILE__, __LINE__)
